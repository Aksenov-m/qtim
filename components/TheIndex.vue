        ...
        <div id="content" class="site-content">
          <div id="primary" class="content-area column full">
            <main id="main" class="site-main">
              <div class="grid portfoliogrid"></div>
              <!-- .grid -->
              <TheaArticle v-for="item in store.articlePage" :key="item.id" :article="item" />
              <nav class="pagination">
                <!-- <span class="page-numbers current">1</span> -->
                <a class="page-numbers" v-for="item in store.totalCounPage" :key="item" @click="store.setPage($event.target.innerHTML
                )">{{ item }}</a>
                <!-- <NuxtLink class="next page-numbers" href="#">Next »</NuxtLink> -->
              </nav>
              <br />
            </main>
            <!-- #main -->
...
await useAsyncData('articles', () => store.getArticles())
...
@font-face {
  ...
  src: url("fonts/genericons-regular-webfont.eot?#iefix") format("embedded-opentype"), url("fonts/genericons-regular-webfont.woff") format("woff"),
...
@font-face {
  ...
  src: url("fonts/behance.eot?61221480#iefix") format("embedded-opentype"), url("fonts/behance.woff?61221480") format("woff"),
    url("fonts/behance.ttf?61221480") format("truetype"), url("fonts/behance.svg?61221480#behance") format("svg");
  font-weight: normal;
  font-style: normal;
}
